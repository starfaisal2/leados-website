          ...
          <div className="demo-wrap">
            ...
            <div className="demo-right" dir="ltr">
              <div className="demo-chat-hdr">
                <div className="demo-ai-av" style={{overflow:"hidden",background:"#7c3aed",padding:0}}><img src="/aria.png" style={{width:"100%",height:"100%",objectFit:"cover",display:"block"}} alt="Aria" /></div>
              ...
              <div className="demo-msgs" ref={msgsRef}>
                {demoMsgs.map((m, i) => (
                  <div key={i} className={`dm${m.f === "u" ? " u" : ""}`}>
                    <div className={`dm-av ${m.f === "a" ? "a-av" : "u-av"}`} style={m.f === "a" ? {overflow:"hidden",background:"#7c3aed",padding:0,fontSize:0} : {}}>{m.f === "a" ? <img src="/aria.png" style={{width:"100%",height:"100%",objectFit:"cover",display:"block"}} alt="Aria" /> : "👤"}</div>
                    <div className={`dm-b ${m.f === "a" ? "ai-msg" : "user-msg"}`}>{m.t}</div>
                  </div>
                ))}
                {typing && <div className="dm"><div className="dm-av a-av" style={{overflow:"hidden",background:"#7c3aed",padding:0,fontSize:0}}><img src="/aria.png" style={{width:"100%",height:"100%",objectFit:"cover",display:"block"}} alt="Aria" /></div><div className="typing-row"><div className="t-dot" /><div className="t-dot" /><div className="t-dot" /></div></div>}
              </div>
